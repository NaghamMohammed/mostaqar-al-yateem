function Aids() {
  ...
  description: 'خدمات وبرامج إنسانية للاجئي فلسطين، تشمل مجموعة من المساعدات والخدمات وفق الأهلية والبرنامج.',
...
},
  {
    ...
    description: 'خدمات ومساعدات اجتماعية وغذائية وطارئة للأسر والفئات المستحقة وفق معايير الوزارة.',
...

  {
    ...
    description: 'خدمات ومساعدات إنسانية وإغاثية وصحية في فلسطين.',
...

  {
    ...
    description: 'جمعية خيرية غير ربحية تقدم برامج تنموية وتدخلات إغاثية في أوقات الطوارئ والأزمات.',
...

  {
    ...
    description: 'برامج إنسانية تشمل المياه والصحة والتغذية والتعليم وحماية الأطفال والدعم النقدي وفق البرامج والفئات المستهدفة.',
...

  {
    ...
    description: 'يقدم مساعدات غذائية ونقدية وخدمات تغذية ودعمًا لسبل العيش للأسر المتضررة في غزة والضفة الغربية.',
  ...
  return (
    <main className="aids-page">
      ...
      <section className="aids-header">
        ...
        <p>
          تعرّف على فرص المساعدة والبرامج المتاحة
